...
public class Pipeline {
    ...
    public Span[] taskNameRecognition(String[] tokens) throws IOException{

        InputStreamFactory inputStreamFactory = new MarkableFileInputStreamFactory(new File("C:/Users/ggrae/OneDrive/Documents/GitHub/TheTechSquad/src/main/resources/models/task-name-recog.txt"));
        ...
        // Train the model
        TokenNameFinderModel model = TokenNameFinderModel.train(
                "en",
                null,
                sampleStream,
                params,
                TokenNameFinderFactory.create(null, null, null, null)
        );
    ...
    public String spansToString(Span[] timeSpans) {
        ...
        for (Span span : timeSpans) {
            for (int i = span.getStart(); i < span.getEnd(); i++) {
                outputString = outputString + span.toString() + " ";
            }
        }
        //System.out.print("]\n\n");
